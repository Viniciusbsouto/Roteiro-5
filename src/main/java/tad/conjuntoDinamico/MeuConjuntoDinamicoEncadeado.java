 ...
 * 
 * Esta classe implementa um conjunto dinâmico de números inteiros utilizando
 * uma lista simplesmente encadeada. Oferece suporte às operações de inserção,
 * remoção, busca, além de predecessor, sucessor, mínimo e máximo.
 */
