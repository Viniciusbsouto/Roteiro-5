...
public class ListaDuplamenteEncadeadaImpl<T extends Comparable<T>> implements ListaDuplamenteEncadeadaIF<T> {
	 ...
	 *
	 * return String com elementos separados por vírgula e espaço, ou vazio se a
	 * lista estiver vazia.
	 */
	@Override
	 ...
	 * return nó predecessor, ou null se o nó for o primeiro (cabeça) ou não
	 * existir.
	 */
	@Override
	 ...
	 * return array contendo os elementos da lista, ou null se a lista estiver
	 * vazia.
	 */
	@Override
	 ...
	 * throws UnsupportedOperationException indica que o método não foi
	 * implementado.
	 */
	@Override
